...
function openRegisterMenu(){
  ...
  box.innerHTML=`<div class="adminHomeMenu"><div class="sectionHead"><h2>Hacer registros</h2><button type="button" data-close-register>×</button></div><p class="hint">Selecciona el módulo que vas a administrar.</p><div class="adminHomeMenuGrid"><button type="button" data-open="personal">Personal</button><button type="button" data-open="assets">Activos fijos</button><button type="button" data-open="inventoryItems">Elementos de inventario</button><button type="button" data-open="novelties">Novedades de activos</button><button type="button" data-open="consumption">Consumo YT / Columnas</button></div></div>`;
