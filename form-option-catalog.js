...
function apply(){
  options(document.querySelector('#personalForm [name="empresa"]'),values('personal.company'));
  options(document.querySelector('#personalForm [name="area"]'),values('personal.area'));
  options(document.querySelector('#personalForm [name="cargo"]'),values('personal.role'));
  options(document.querySelector('#plazaCollaboratorForm [name="empresa"]'),values('personal.company'));
  options(document.querySelector('#plazaCollaboratorForm [name="area"]'),values('personal.area'));
  options(document.querySelector('#plazaCollaboratorForm [name="cargo"]'),values('personal.role'));
...
window.SKFormOptions={values,load,apply,mountAdmin,labels,defaults};
